...
* OPF receives a report of "Sybil Publishing" where an someone has created more than one identical pool, where “identical” means same data service, same ERC20 licensing terms, and same pool basetoken. (This is for the context of Ocean Data Farming).
